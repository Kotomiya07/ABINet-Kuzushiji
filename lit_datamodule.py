    ...
    def setup(self, stage=None):
        if self.config.global_stage == 'pretrain-language':
            ...
            common_kwargs = dict(
                ...
                resize_mode=getattr(self.config, "dataset_resize_mode", "legacy"),
                padding_mode=getattr(self.config, "dataset_padding_mode", "replicate"),
                padding_align=getattr(self.config, "dataset_padding_align", "center"),
                padding_value=getattr(self.config, "dataset_padding_value", None),
